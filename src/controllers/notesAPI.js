...
export const addNote = async (req, res) => {
    try {
        ...
        res.status(400).json({
            message: err instanceof Error ? err.message : "Error while adding the note.",
        });
    }
};
export const getNote = async (req, res) => {
    try {
        ...
        res.status(400).json({
            message: err instanceof Error ? err.message : "Error while getting notes.",
        });
    }
};
export const deleteNote = async (req, res) => {
    try {
        ...
        res.status(400).json({
            message: err instanceof Error ? err.message : "Error while deleting note.",
        });
    }
};
